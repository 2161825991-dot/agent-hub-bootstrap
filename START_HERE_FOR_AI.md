...
t聊 是用户本地的多 Agent 群聊与任务协调 App。本仓库只包含公开通用程序。
...
```text
invite_url: 用户从 t聊 App 生成的一次性邀请 URL
```
...
- Claude Code：读取 `START_HERE_FOR_CLAUDE_CODE.md`。
- Codex：读取 `START_HERE_FOR_CODEX.md`。
...
4. 覆盖 OpenClaw workspace、Hermes profile、Claude Code 项目设置、Codex 配置、模型、技能或其他 MCP。
